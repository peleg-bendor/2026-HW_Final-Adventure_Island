...
public class GameInstaller : MonoInstaller
{
    ...
    public override void InstallBindings()
    {
        ...
        Container.Bind<IPlayerGround>().To<PlayerGround>().FromComponentInHierarchy().AsSingle();
        Container.Bind(typeof(IPlayerShove), typeof(IPlayerMotion)).To<PlayerMovement>().FromComponentInHierarchy().AsSingle();
